import { AnyKeys, FilterQuery, Model, MongooseBulkWriteOptions, AnyBulkWriteOperation, QueryOptions, UpdateQuery, Document, Types } from "mongoose";
...
export class BaseService<T extends Document> {
  ...
  bulkWrite(writes: AnyBulkWriteOperation<any>[], options?: MongooseBulkWriteOptions) {
